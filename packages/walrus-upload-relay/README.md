...
Walrus Upload Relay with extra features.
...
This image is based on the official [mysten/walrus-upload-relay](https://hub.docker.com/r/mysten/walrus-upload-relay/) image.
...
- Multi-arch support for `amd64` and `arm64` platforms
